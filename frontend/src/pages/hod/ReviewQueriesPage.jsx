import { Card, Table, Tag, Typography, Button, Modal, Form, Input, Space, Select } from 'antd';
...
export default function ReviewQueriesPage() {
  ...
  const [queries, setQueries] = useState(
    MOCK_QUERIES.filter((q) => q.department === currentUser.department)
  );
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      ...
      <Card>
        <Table columns={columns} dataSource={queries} rowKey="id" pagination={false} size="middle" />
      </Card>
